...
<!--
			...
			<p>You can also integrate the MailChimp API Module into your own modules, templates, callouts, forms, or wherever else you want to drive subscribers.</p>
			<p>One simple way is to build in module dependencies:</p>
			<pre>if (bigtree_module_exists("BTXMailChimpAPI")) {
	// The module exists! Why not prompt the user to subscribe?
}</pre>
-->
		<? } ?>
	</section>
