<script type="text/javascript">
	...
	$(".icon_edit").live("click",function() {
		...
		$.ajax("<?=$aroot?>ajax/developer/load-field-options/", { type: "POST", data: { template: "true", type: $("#type_" + key).val(), data: $("#options_" + key).val() }, complete: function(response) {
